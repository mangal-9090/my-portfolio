      ...
      <div className="max-w-screen-lg p-4 mx-auto flex flex-col justify-center w-full">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-8 px-4 sm:px-0">
          {portfolios.map(({ id, src, demoUrl, repoUrl }) => (
            <div key={id} className="shadow-md shadow-gray-600 rounded-lg overflow-hidden bg-gray-900 flex flex-col">
              ...
              <div className="flex items-center justify-center flex-wrap p-4 mt-auto">
                <button
